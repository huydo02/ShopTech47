...
const CreateProduct = () => {
    ...
    try {
        useEffect(() => {
            const fetchApi = async () => {
                await fetch("http://localhost:3001/admin/list-product/create")
                    .then(res => res.json())
                    .then(data => {
    ...
    const handleSubmit = async (values) => {
        ...
        try {
            const res = await fetch("http://localhost:3001/admin/list-product/create", {
                method: "POST",
                body: formData,
            });
                        ...
                        >
                            <div className="form-left">
                                ...
                                {/* <Form.Item label="Hình ảnh" name="thumbnail" valuePropName="fileList" getValueFromEvent={normFile}>
                                    <Upload name='thumbnail' action="http://localhost:3001/admin/list-product/create" listType="picture-card">
