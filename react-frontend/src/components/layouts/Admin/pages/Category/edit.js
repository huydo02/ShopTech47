...
const EditCategory = () => {
    ...
    const fetchApi = async () => {
        try {
            const response = await fetch(`http://localhost:3001/admin/list-category/edit/${idCategory.id}`);
    ...
    const onFinish = async (values) => {
        ...
        try {
            const res = await fetch(`http://localhost:3001/admin/list-category/edit/${idCategory.id}`, {
                method: "PATCH",
                headers: {
